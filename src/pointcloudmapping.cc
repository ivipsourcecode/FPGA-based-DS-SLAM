...
{ 
    ros::NodeHandle n;
    pclPoint_pub = n.advertise<sensor_msgs::PointCloud2>("/ORB_SLAM2_PointMap_SegNetM/pcl_point",100000);
    ros::Rate r(5);
    while(ros::ok())
    {
        {
        ...
        ofstream outfile("/home/hero/catkin_ws/src/DS_SLAM2/c.txt" , ios::app);
        outfile << "show kf map, size=" << KfMap->points.size() << endl;
