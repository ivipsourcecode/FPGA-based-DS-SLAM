...
System::System(const string &strVocFile, const string &strSettingsFile, const string &pascal_mean, const string &pascal_weights, const string &pascal_frac, const string &pascal_png,const string &pascal_aocx, const eSensor sensor,
			   ...
			   mbDeactivateLocalizationMode(false)
{
    ...
    mpSegment =new Segment(pascal_mean,pascal_weights,pascal_frac,pascal_png,pascal_aocx);
