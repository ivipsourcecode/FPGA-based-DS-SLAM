...
public:
    ...
    System(const string &strVocFile, const string &strSettingsFile, const string &pascal_mean, const string &pascal_weights, const string &pascal_frac,const string &pascal_png, const string &pascal_aocx,const eSensor sensor=MONOCULAR, Viewer* v=NULL, Map* m=NULL, ORBVocabulary* voc = NULL);
